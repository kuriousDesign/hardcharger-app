...
function PageHeaderHeading({
  ...
  return (
    <h1
      className={cn(
        "text-warning-foreground leading-tighter max-w-2xl text-4xl font-semibold tracking-tight text-balance lg:leading-[1.1] lg:font-semibold xl:text-5xl xl:tracking-tighter",
        className
      )}
      {...props}
    />
